...
namespace Apple.Receipt.Verificator.Services
{
    internal class AppleReceiptVerificatorService : IAppleReceiptVerificatorService
    {
        ...
        private readonly IAppStoreConnectAPI _appStoreConnect;
        private readonly IOptionsSnapshot<AppStoreReceiptVerifierSettings> _settings;
        ...
        public AppleReceiptVerificatorService(
            ...
            IOptionsSnapshot<AppStoreReceiptVerifierSettings> settings,
            IAppStoreConnectAPI appStoreConnect,
            IAppleReceiptCustomVerificatorService? customValidation = null
        )
        {
            _appStoreConnect = appStoreConnect;
            _logger = logger;
        ...
        {
            return await VerifyReceiptAsync(receiptData);
        }
        ...
        private async Task<AppleReceiptVerificationResult?> VerifyReceiptAsync(string receiptData)
        {
