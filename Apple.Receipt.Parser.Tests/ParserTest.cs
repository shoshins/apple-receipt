...
namespace Apple.Receipt.Parser.Tests
{
    public class ParserTest : IDisposable
    {
        ...
        [Fact]
        public void ParsingTestZero()
        {
            // TODO: Actualize ideal object and activate the test.
            ...
            //     "receipt_creation_date": "2015-08-13 07:50:46 Etc/GMT",
            //     "receipt_creation_date_ms": "1439452246000",
            //     "receipt_creation_date_pst": "2015-08-13 00:50:46 America/Los_Angeles",
            //     "request_date": "2015-11-21 18:17:47 Etc/GMT",
            //     "request_date_ms": "1448129867409",
            //     "request_date_pst": "2015-11-21 10:17:47 America/Los_Angeles",
            ...
            //         "purchase_date": "2015-08-07 20:37:55 Etc/GMT",
            //         "purchase_date_ms": "1438979875000",
            //         "purchase_date_pst": "2015-08-07 13:37:55 America/Los_Angeles",
            //         "original_purchase_date": "2015-08-07 20:37:55 Etc/GMT",
            //         "original_purchase_date_ms": "1438979875000",
            //         "original_purchase_date_pst": "2015-08-07 13:37:55 America/Los_Angeles",
            ...
            AppleAppReceipt ideal = new AppleAppReceipt
            {
                ...
                ReceiptCreationDateMs = "1448129867000",
                ...
                PurchaseReceipts = new List<AppleInAppPurchaseReceipt>
                {
                    ...
                    new AppleInAppPurchaseReceipt()
                    {
                        OriginalTransactionId = "1000000167942121",
                        TransactionId = "1000000167942121",
                        Quantity = "1",
                        OriginalPurchaseDateMs = "1439840825000",
                        PurchaseDateMs = "1439840825000",
                        ProductId = "consumable",
                    },
                    new AppleInAppPurchaseReceipt()
                    {
                        OriginalTransactionId = "1000000168437870",
                        TransactionId = "1000000168437870",
                        Quantity = "1",
                        OriginalPurchaseDateMs = "1440086973000",
                        PurchaseDateMs = "1440086973000",
                        ProductId = "nonconsumable"
                    }
                }
            };
            #endregion
            ...
            // avoid 35 receipts check (too long to enter so much amount of ideal objects.). 
            applicant.PurchaseReceipts = applicant.PurchaseReceipts.Take(3).ToList();
