...
namespace Apple.Receipt.Example.ConsoleApp
{
    class Program
    {
        private static IAppleReceiptParserService _parserService;
        private static IAppleReceiptVerificatorService _verificatorService;
