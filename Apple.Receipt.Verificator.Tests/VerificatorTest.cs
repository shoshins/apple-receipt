...
namespace Apple.Receipt.Verificator.Tests
{
    ...
    public class VerificatorTest
    {
        ...
        public void TestFixtureSetUp()
        {
            ...
            containerBuilder.RegisterType<AppleReceiptCustomVerificatorService>().As<IAppleReceiptCustomVerificatorService>();
            var settings = new AppleReceiptVerificationSettings("XXXX", "https://sandbox.itunes.apple.com/verifyReceipt", new[] { "com.mbaasy.ios.demo" }, new LoggerConfiguration(), true);
            var module = new AppleReceiptVerificatorModule(settings);
